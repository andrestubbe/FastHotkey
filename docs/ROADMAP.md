# FastHotkey Roadmap 🗺️

**Vision:** To provide the fastest possible native primitives for hotkey management by aggressively bypassing bottlenecks in standard Java.
